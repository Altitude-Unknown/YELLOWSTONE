...
#define YELLOWSTONE_RX_PIN 20
#define YELLOWSTONE_TX_PIN 21
...
void printHeartbeat() {
  ...
  Serial.print("SHERPA,HEARTBEAT,rx_count,");
...
void setup() {
  ...
  Serial.println("SHERPA,BOOT,UART_DIAGNOSTIC");
  Serial.println("SHERPA,YELLOWSTONE_UART_READY,rx_pin,20,tx_pin,21,baud,115200");
}
